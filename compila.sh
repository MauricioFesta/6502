...
ld65 src/reset.o src/background_tiles.o src/read_ax.o src/read_by.o src/read_down.o src/read_start.o src/read_up.o src/read_right.o src/read_left.o src/spaceship.o src/ship_enemies.o src/missile.o src/utils.o -C nes.cfg -o spaceship.nes